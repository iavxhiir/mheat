  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'MHEAT',
        description:
          'Detect Mediterranean marine heatwaves on Copernicus Marine SST. EDITO-hosted.',
        theme_color: '#0f1620',
    ...
    rollupOptions: {
      output: {
        ...
        manualChunks(id: string) {
          ...
          if (id.includes('node_modules/react-dom') || id.includes('node_modules/react/') || id.endsWith('node_modules/react') || id.includes('node_modules/scheduler')) return 'react';
        },
      },
    },
  },
